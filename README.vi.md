<p align="center">
  <a href="https://themesic.com/product/rest-api-module-for-perfex-crm-connect-your-perfex-crm-with-third-party-applications/">
    <img src="assets/perfex-crm-rest-api.jpg" alt="REST API cho Perfex CRM — kết nối Perfex CRM với AI agent, Zapier, WooCommerce, n8n và các ứng dụng bên thứ ba" width="100%">
  </a>
</p>
...
- 🧾 **Đặc tả OpenAPI 3.1:** `GET https://yourdomain.com/api/openapi.json`
